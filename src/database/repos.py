...
class ImageRepo(BaseRepo[Image]):
    ...
    def add_many(self, images: List[Image]):
        ...
        rows = [{
            ...
            'atomic_scale': img.atomic_scale,
            'camera_parameters': img.camera_parameters,
            'camera_type': img.camera_type,
            'compass_angle': img.compass_angle,
            'computed_altitude': img.computed_altitude,
            'computed_compass_angle': img.computed_compass_angle,
            'computed_rotation': img.computed_rotation,
            ...
            'organization_name': img.organization_name,
            'organization_slug': img.organization_slug,
